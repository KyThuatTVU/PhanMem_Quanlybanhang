  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="login-glass-card p-7 sm:p-8 rounded-[2rem] space-y-6">
          
          {/* Header Tiêu đề & Logo */}
          <div className="text-center space-y-3">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/90 p-2 border border-white/80 shadow-lg shadow-cyan-950/30 mb-1">
          ...
          <div className="relative flex items-center justify-center my-4">
            ...
            <span className="bg-[#eaf7f9]/95 px-3 text-[11px] font-semibold text-slate-500 uppercase tracking-wider absolute">
              hoặc
            </span>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white/55 hover:bg-white/80 border border-white/80 rounded-xl text-slate-700 text-sm font-semibold shadow-sm hover:shadow transition duration-200"
          >
          ...
          <div className="pt-3 border-t border-slate-300/60 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              <button
                ...
                className="px-2.5 py-1.5 bg-cyan-50/80 hover:bg-cyan-100 text-cyan-700 border border-cyan-200/70 rounded-lg font-medium transition text-center"
              >
                Thu Ngân
              </button>
              <button
                ...
                className="px-2.5 py-1.5 bg-sky-50/80 hover:bg-sky-100 text-sky-700 border border-sky-200/70 rounded-lg font-medium transition text-center"
              >
                Chủ Quán
              </button>
              <button
                ...
                className="px-2.5 py-1.5 bg-amber-50/85 hover:bg-amber-100 text-amber-700 border border-amber-200/70 rounded-lg font-medium transition text-center"
              >
                Thủ Kho
              </button>
            </div>
        ...
        <p className="text-center text-xs text-white/90 mt-6 font-medium drop-shadow-sm">
          &copy; 2026 {settings.STORE_NAME}. Powered by React.js & Node.js.
        </p>
      </div>
    </div>
  );
