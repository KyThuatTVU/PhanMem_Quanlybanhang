...
export const LoginPage = () => {
  ...
  return (
    <div className="login-shell min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="login-glass-card p-7 sm:p-8 rounded-[2rem] space-y-6">
          ...
          <div className="text-center space-y-3">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/80 p-2 border border-white shadow-lg shadow-sky-500/15 mb-1">
          ...
          <div className="relative flex items-center justify-center my-4">
            ...
            <span className="bg-[#eef8fb]/90 px-3 text-[11px] font-semibold text-slate-400 uppercase tracking-wider absolute">
              hoặc
            </span>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white/65 hover:bg-white/90 border border-white/90 rounded-xl text-slate-700 text-sm font-semibold shadow-sm hover:shadow transition duration-200"
          >
